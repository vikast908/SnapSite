...
- Load unpacked → select the getinspire/ folder
...
What’s Included
- index.html — DOM snapshot, local asset paths
...
- Heuristic auto-scrolls until bottom is stable ≥2s
- Caps: runtime, max assets, ZIP size, and concurrency (configurable in Options)

Settings
- Options page lets you adjust caps, redact behavior, and denylist
